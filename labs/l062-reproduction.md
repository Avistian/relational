# L062 reproduction and evidence contract

Primary source: [TabPFN v1](https://arxiv.org/html/2207.01848v6). [Lesson](../lessons/0062-tabpfn-v1.html).
...
2. **Measured evidence:** `_verify_l062_results.json` contains the actual local run or frozen-result
...
```bash
.venv/bin/python labs/_run_foundation.py --lesson 62 --preset lab --output labs/data/cache/foundation/l062-rerun.json
...
```bash
modal run --detach modal/foundation_repro.py --lesson 62 --preset closer
```
