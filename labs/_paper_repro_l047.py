...
GAPS = [
    ...
    'Missing and unseen categories share local code 0; release uses separate missing masks and a full-table vocabulary.',
    'Numeric scale here uses observed training values and degenerate scale 1; release mean-imputes then scales, clamping at 1e-6.',
    'NumPy batch permutations and constructor RNG consumption differ from released PyTorch DataLoader/initialization; equal seeds do not align trajectories.',
