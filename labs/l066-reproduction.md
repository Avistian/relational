# L066 reproduction and evidence contract

Primary source: [TabICL, Sections 3–4](https://arxiv.org/html/2502.05564v1). [Lesson](../lessons/0066-tabicl-column-row-attention.html).
...
2. **Measured evidence:** `_verify_l066_results.json` contains the actual local run or frozen-result
...
```bash
.venv/bin/python labs/_run_foundation.py --lesson 66 --preset lab --output labs/data/cache/foundation/l066-rerun.json
...
```bash
modal run --detach modal/foundation_repro.py --lesson 66 --preset closer
```
