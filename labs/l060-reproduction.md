# L060 reproduction and evidence contract

Primary source: [TabArena and TabReD protocols](https://arxiv.org/html/2506.16791v1). [Lesson](../lessons/0060-broad-model-comparison.html).
...
2. **Measured evidence:** `_verify_l060_results.json` contains the actual local run or frozen-result
...
```bash
.venv/bin/python labs/_run_foundation.py --lesson 60 --preset lab --output labs/data/cache/foundation/l060-rerun.json
