# L063 reproduction and evidence contract

Primary source: [TabPFN v1 prior](https://arxiv.org/html/2207.01848v6). [Lesson](../lessons/0063-synthetic-scm-prior.html).
...
2. **Measured evidence:** `_verify_l063_results.json` contains the actual local run or frozen-result
...
```bash
.venv/bin/python labs/_run_foundation.py --lesson 63 --preset lab --output labs/data/cache/foundation/l063-rerun.json
