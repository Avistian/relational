...
Tier B, full original public SNAP/JODIE Wikipedia stream, shared raw bytes with L102. TGAT release replay: full 157474-event graph, source-held-node split, ten independent runs; released per-branch final-event omission is retained and audited. The matched TGAT/TGN course lane uses a separate 2000/400/400 retained event graph. Raw SHA-256 and population semantics: [protocol](../l103-reproduction.md).
