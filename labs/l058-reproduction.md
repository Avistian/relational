# L058 reproduction and evidence contract

Primary source: [TALENT Sections 4–5 and 8](https://arxiv.org/html/2407.00956v3). [Lesson](../lessons/0058-surveys-meta-benchmarks.html).
...
2. **Measured evidence:** `_verify_l058_results.json` contains the actual local run or frozen-result
...
```bash
.venv/bin/python labs/_run_foundation.py --lesson 58 --preset lab --output labs/data/cache/foundation/l058-rerun.json
...
```bash
modal run --detach modal/foundation_repro.py --lesson 58 --preset closer
```
