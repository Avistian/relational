...
path=P/'relkit/compare_l099.py'
assert path.exists(), 'L099 visible implementation is not yet present'
...
(P/'_verify_l099_results.json').write_text(json.dumps(report,indent=2)+'\n');print(report)
