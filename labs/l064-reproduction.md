# L064 reproduction and evidence contract

Primary source: [Nature TabPFN v2](https://www.nature.com/articles/s41586-024-08328-6). [Lesson](../lessons/0064-tabpfn-v2.html).
...
2. **Measured evidence:** `_verify_l064_results.json` contains the actual local run or frozen-result
...
```bash
.venv/bin/python labs/_run_foundation.py --lesson 64 --preset lab --output labs/data/cache/foundation/l064-rerun.json
...
```bash
modal run --detach modal/foundation_repro.py --lesson 64 --preset closer
```
