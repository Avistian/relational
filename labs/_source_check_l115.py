...
def original():
    sys.path.insert(0,str(P/'sources/l115'))
    spec=importlib.util.spec_from_file_location('ogb_original',P/'sources/l115/gnn.py');m=importlib.util.module_from_spec(spec);spec.loader.exec_module(m);return m.GCN
...
if __name__=='__main__':
    r=check(sys.argv[1] if len(sys.argv)>1 else 'cpu');(P/'_source_check_l115_results.json').write_text(json.dumps(r,indent=2));print(r)
