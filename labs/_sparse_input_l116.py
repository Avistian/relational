...
from relkit.debug_l116 import normalized_adjacency
...
if __name__=='__main__':
    r=check();Path(__file__).with_name('_sparse_input_l116_results.json').write_text(json.dumps(r,indent=2));print(r)
