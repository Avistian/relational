...
<figure class="model-map"><div class="model-map-scroll" tabindex="0" role="region" aria-label="Scrollable architecture: A method map · ask four independent questions"><img src="../assets/architectures/094-taxonomy.svg" alt="Survey synthesis: a route specification and an encoder are separate choices. This is a workflow, not a new architecture or an accuracy ranking. R-GCN, HAN and HGT occupy several independent taxonomy axes."></div><figcaption>Survey synthesis: a route specification and an encoder are separate choices. This is a workflow, not a new architecture or an accuracy ranking. R-GCN, HAN and HGT occupy several independent taxonomy axes.</figcaption></figure>
...
<figure class="model-map"><div class="model-map-scroll" tabindex="0" role="region" aria-label="Scrollable architecture: metapath2vec · from typed walks to stored vectors"><img src="../assets/architectures/094-metapath2vec.svg" alt="Conceptual survey map; no new implementation or benchmark run in L094. The typed walk constrains observed contexts. The enhanced ++ objective also conditions normalization on context type; do not conflate them."></div><figcaption>Conceptual survey map; no new implementation or benchmark run in L094. The typed walk constrains observed contexts. The enhanced ++ objective also conditions normalization on context type; do not conflate them.</figcaption></figure>
