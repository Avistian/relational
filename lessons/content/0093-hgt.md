...
<figure class="model-map"><div class="model-map-scroll" tabindex="0" role="region" aria-label="Scrollable architecture: HGT · compatibility and content take separate routes"><img src="../assets/architectures/093-hgt.svg" alt="One typed edge feeds the score branch and the message branch. Parameters share by node type and relation/head. RTE changes source K/V inputs; time availability is a separate data-access contract."></div><figcaption>One typed edge feeds the score branch and the message branch. Parameters share by node type and relation/head. RTE changes source K/V inputs; time availability is a separate data-access contract.</figcaption></figure>
