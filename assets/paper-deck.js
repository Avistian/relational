...
, {"id": "xu2020-tgat-time", "paper": "Xu et al. \u2014 Inductive Representation Learning on Temporal Graphs", "year": 2020, "lesson": 103, "front": "How does TGAT encode time, and what prevents future information entering a recursive query?", "back": "Time features join node and edge representations in keys and values. Every child is queried at the connecting interaction time and retrieves strictly earlier history. Paired Fourier features motivate stationary kernels; the released encoder uses learned cosines and phases. TGAT has no persistent recurrent node memory but still requires historical events and controlled sampling."}
, {"id": "kapoor2022-temporal-audit", "paper": "Kapoor & Narayanan \u2014 Leakage and the Reproducibility Crisis", "year": 2022, "lesson": 104, "front": "Why does chronological splitting alone fail to certify a temporal model?", "back": "It constrains target ordering but may leave unavailable features, future neighbors, premature targets or future-driven model selection. Model info sheets connect the evaluated information-access rules to the scientific claim. L104 makes those rules executable; it does not reproduce the civil-war experiments."}
, {"id": "pareja2020-evolvegcn-state", "paper": "Pareja et al. \u2014 EvolveGCN", "year": 2020, "lesson": 107, "front": "Which object evolves in EvolveGCN, and why must the released O protocol be inspected?", "back": "The recurrent object is a GCN weight matrix, not a node-indexed embedding table. H conditions it on summarized node features. Released O uses GRU-style recurrence instead of paper LSTM; resetting its observation-free recurrence for every fixed-length window removes deterministic dependence on earlier graph content."}
];
})(window);
