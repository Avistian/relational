...
- [Why trees beat DL on tabular — Grinsztajn et al., NeurIPS 2022](https://arxiv.org/abs/2207.08815)
  Three inductive biases (irregular targets, uninformative features, rotation non-invariance). Use for: Lesson 010 Q1-checkpoint primary reading; **Lesson 039 Year 1 synthesis primary reading** (re-read full paper with the essay skeleton in hand — each section earns a paragraph and forces a boundary); year-1 exit exam. Explains why a competently-built GBDT is the baseline the thesis must beat — and why that result is conditional, not universal.
